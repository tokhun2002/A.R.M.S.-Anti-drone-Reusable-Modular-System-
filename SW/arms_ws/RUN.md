...
export GZ_SIM_RESOURCE_PATH=$GZ_SIM_RESOURCE_PATH:/path/to/PX4-Autopilot/Tools/simulation/gz/models
...
>
> ```bash
> # 빨간 공이 프레임 중앙에 있다고 가정한 가짜 detection 발행
